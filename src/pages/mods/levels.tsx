  ...
  let mySwal = withReactContent(Swal)
    ...
    <div id={styles.content}>
      ...
      <div id={styles.show}>
        ...
        }}/>{editedLevel.position != level.position ? " *" : ""}: <textarea rows={1} placeholder="Name..."  style={{width: `${Math.min(editedLevel.name.length || 4, 20)}ch`}} defaultValue={level.name} onChange={(e:any) => {
          setTimeout(() => {
            let newLevel = structuredClone(editedLevel)
        ...
        <br></br>
        <h1 style={{textAlign: "center"}} className="white">Host: <textarea rows={1} style={{maxWidth: `${Math.min(editedLevel.host.length || 4, 20)}ch`}} defaultValue={level.host} onChange={(e:any) => {
            setTimeout(() => {
              let newLevel = structuredClone(editedLevel)
        ...
        <br></br>
        <h1 style={{textAlign: "center"}} className="white">Verifier: <textarea rows={1} style={{width: `${Math.min(editedLevel.verifier.length || 4, 20)}ch`}} defaultValue={level.verifier} onChange={(e:any) => {
          setTimeout(() => {
            let newLevel = structuredClone(editedLevel)
        ...
        <br></br>
        <h1 style={{textAlign: "center"}} className="white">YT code: <textarea rows={1} style={{width: `${Math.min(editedLevel.ytcode.length || 4, 20)}ch`}} defaultValue={level.ytcode} onChange={(e:any) => {
           setTimeout(() => {
            let newLevel = structuredClone(editedLevel)
        ...
        <div>
          ...
          <br></br>
            <h1 style={{textAlign: "center"}} className="white">Name: <textarea rows={1} className="record-adding" style={{width: `${Math.min(newRecord.name.length || 5, 20)}ch`}} placeholder="Name..." onChange={((e:any) => {
             setTimeout(() => {
              let {value} = e.target
                        setNewRecord({
                          ...newRecord,
...
<br></br>
<h1 style={{textAlign: "center"}} className="white">Link: <textarea rows={1} className="record-adding" style={{width: `${Math.min(newRecord.link.length || 25, 20)}ch`}} onChange={(e:any) => {
  setTimeout(() => {
    let {value} = e.target
              setNewRecord({
                ...newRecord,
        ...
        {!level?.list.length || level.list[0].name == "" ? <h1 style={{textAlign: "center"}} className="white">No list records</h1> : level?.list?.map((e: any) => {
         ...
         return <div key={e.link}>
          ...
          <br></br>
            <h1 style={{textAlign: "center"}} className="white">Name: <textarea rows={1} style={{width: `${Math.min(editedLevel.list[i].name.length || 5, 20)}ch`}} defaultValue={level.list[i].name} onChange={(e:any) => {
           setTimeout(() => {
            let newLevel = structuredClone(editedLevel)
...
<br></br>
<h1 style={{textAlign: "center"}} className="white">Link: <textarea rows={1} style={{width: `${Math.min(editedLevel.list[i].link.length || 25, 20)}ch`}} defaultValue={level.list[i].link} onChange={(e:any) => {
           setTimeout(() => {
            let newLevel = structuredClone(editedLevel)
