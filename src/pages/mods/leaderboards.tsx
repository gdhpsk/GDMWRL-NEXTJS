    ...
    <div id={styles.content}>
      ...
      <div id={styles.show}>
            {profile ? <div>
                ...
                <br></br>
                <h1 style={{textAlign: "center"}} className="white">Name: <textarea rows={2} style={{width: `20ch`}} defaultValue={profile.name} onChange={(e:any) => {
                    setTimeout(() => {
                        let {value} = e.target
                    setEditedProfile({
                        ...editedProfile,
                ...
                <h1 style={{textAlign: "center"}} className="white">Youtube: <textarea rows={2} style={{width: `20ch`}} defaultValue={profile?.socials?.[0]?.youtube} onChange={(e:any) => {
                    setTimeout(() => {
                        let {value} = e.target
                    let socials = [{
                ...
                <h1 style={{textAlign: "center"}} className="white">Twitter: <textarea rows={2} style={{width: `20ch`}} defaultValue={profile?.socials?.[0]?.twitter} onChange={(e:any) => {
                    setTimeout(() => {
                        let {value} = e.target
                    let socials = [{
                ...
                <h1 style={{textAlign: "center"}} className="white">Twitch: <textarea rows={2} style={{width: `${editedProfile.socials?.[0]?.twitch?.length || 10}ch`}} defaultValue={profile?.socials?.[0]?.twitch} onChange={(e:any) => {
                   setTimeout(() => {
                    let {value} = e.target
                    let socials = [{
                ...
                <h1 style={{textAlign: "center"}} className="white">Discord Tag: <textarea rows={2} style={{width: `20ch`}} defaultValue={profile?.socials?.[0]?.discord?.[0]} onChange={(e:any) => {
                    setTimeout(() => {
                        let {value} = e.target
                    let socials = [{
                        twitter: editedProfile.socials?.[0]?.twitter,
                ...
                <h1 style={{textAlign: "center"}} className="white">Discord Server: <textarea rows={2} style={{width: `20ch`}} defaultValue={profile?.socials?.[0]?.discord?.[1]} onChange={(e:any) => {
                    setTimeout(() => {
                        let {value} = e.target
                    let socials = [{
                        twitter: editedProfile.socials?.[0]?.twitter,
